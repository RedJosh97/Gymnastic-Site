<template>
  <div class="pt-14 -z-50 -mt-3 bg-gray-950 h-full relative pb-20">
    ...
    <div class="flex justify-center flex-col items-center">
      <p class="text-white pt-8 max-w-2xl text-center text-lg leading-7">
      ...
      <div class="relative">
        <img class="max-w-2xl pt-8" src="/public/image/Rectangle 10.png" />
        <img
          class="max-w-2xl absolute -bottom-2 -left-2.5 -z-30"
